...
public abstract class BaseRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BaseRecyclerViewAdapter(Context context, View.OnClickListener tryAgainClickListener) {
        this(context);
        mTryAgainClickListener = tryAgainClickListener;
    }

    public BaseRecyclerViewAdapter(Context context, View.OnClickListener tryAgainClickListener, OnEndReached onEndReached) {
        this(context, tryAgainClickListener);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof PlaceHolderVH) {
            if (holder.getItemViewType() == TYPE_EMPTY) {
                ((PlaceHolderVH) holder).bind(getEmptyLabel(getContext()), getEmptyIcon(getContext()), null, isViewWrapped());
            } else if (holder.getItemViewType() == TYPE_ERROR) {
                ((PlaceHolderVH) holder).bind(getErrorLabel(getContext()), getErrorIcon(getContext()), mTryAgainClickListener, isViewWrapped());
            }
    ...
    private boolean isViewWrapped() {
        return mWrapView == null ? mAlwaysShowFooter || mAlwaysShowHeader : mWrapView;
    }

    public void setWrapView(boolean wrapView) {
        mWrapView = wrapView;
    }
    ...
    public class PlaceHolderVH extends RecyclerView.ViewHolder {
        ...
        public void bind(String emptyMsg, Drawable drawable, View.OnClickListener refreshClickListener, boolean wrapView) {
